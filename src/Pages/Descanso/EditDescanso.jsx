...
const EditDescanso = ({ Selected, setSelected }) => {
    ...
    // Usar selected para sacar los datos del descanso
    return (
        <CustomModal Open={Open} setOpen={setOpen} handleClose={handleClose}>
            <div className="flex items-center mb-2">
                <SecurityIcon className="w-6 h-6 mr-2" />
                <h1 className='text-lg font-bold fl'>Editar un descanso</h1>
            </div>
            <form>
                <div>
                    {/* Inputs para el descanso */}
