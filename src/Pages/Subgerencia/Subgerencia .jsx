...
import AddSubgerencia from './AddSubgerencia';
import EditSubgerencia from './EditSubgerencia';
import deleteSubgerencia from './DeleteSubgerencia';
...
const Subgerencia = (moduleName) => {
    ...
    const fetchData = async (url) => {
        ...
        try {
            const response = await getData(`${import.meta.env.VITE_APP_ENDPOINT}/subgerencias/${urlParams}`, token)
    ...
    const onDelete = (obj) => {
        deleteSubgerencia(obj, refreshData, token, deleteData)
    }
    ...
    return (
        <>
            ...
            {canEdit && <EditSubgerencia Selected={Selected} setSelected={setSelected} refreshData={refreshData} />}
