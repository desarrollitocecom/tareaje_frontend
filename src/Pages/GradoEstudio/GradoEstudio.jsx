...
const GradoEstudio = (moduleName) => {
    ...
    const fetchData = async (url) => {
        ...
        try {
          const response = await getData(`${import.meta.env.VITE_APP_ENDPOINT}/gradoestudios/${urlParams}`,token)
    ...
    const onDelete = (obj) => {
        deleteGradoEstudio(obj, refreshData, token, deleteData)
    }
    ...
    return (
        <>
                        ...
                        <div className='w-full flex flex-col md:flex-row justify-space-between pb-6 gap-3'>
                            ...
                            <div className='w-full flex items-center justify-end gap-3'>
                                <div className='flex items-center'>
                                    ...
                                    {canCreate && <AddGradoEstudio refreshData={refreshData} />}
                                </div>
                                <SearchInput/>
            ...
            {canEdit && <EditGradoEstudio Selected={Selected} setSelected={setSelected} refreshData={refreshData} />}
